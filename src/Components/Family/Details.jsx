...
function Details({changeState}) {
  ...
  const details = [
    {name:"Mansi katariya",relation:"xyz",age:"20",gender:"xyz",height:"xyz",weight:"76",bmi:"20"},
  ]
  ...
  return (
    ...
    <div className="flex absolute">
      ...
      <div className=" flex gap-10 p-10 ">
        ...
        <div onClick={handlePopup} className="flex items-center gap-2 p-2 rounded-2xl bg-violet-300 ">
          <img src="./asset/addm.png" className="w-[20px] h-[20px]" />
          <p className="font-bold">Add New Members</p>
        </div>
      </div>
      <div className="tablediv p-4 bg-black text-white w-[85vw] h-[55vh] border rounded-2xl">
        ...
        <div className="flex flex-col h-[85%] gap-10 overflow-y-scroll">
          {details.map((items,i)=>{
            return(
              <div className="flex p-4 gap-24 align-middle bg-white text-black rounded-xl" key={i}>
